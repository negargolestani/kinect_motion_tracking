...
#     synth_dataset = generate_synth_motion_data( ['arduino'], save_dataset_name='synth_00', resample_dt=.1, N=1000, window_length=15, epochs=500, hiddendim=300, latentdim=300)
####################################################################################################################################################
